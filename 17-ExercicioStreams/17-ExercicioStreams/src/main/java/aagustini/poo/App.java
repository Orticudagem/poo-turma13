...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n1. Funcionários do setor de vendas:");
            lista.stream()
               .filter(Pessoa -> Pessoa.getDpto() == Pessoa.getDpto().VENDAS)
        ...
        System.out.println("\n3. Nomes (em maiúsculas) dos funcionários do setor de vendas");
            lista.stream()
                ...
                .forEach(Pessoa -> System.out.println(Pessoa.toUpperCase()));

        System.out.println("\n4. Todos os gerentes:");
            lista.stream()
                .filter(Pessoa -> Pessoa.getDpto() == Pessoa.getDpto().GERENCIA)
                .forEach(Pessoa -> System.out.println(Pessoa));
